        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex gap-2 mb-3">
              <RouterLink class="btn btn-primary" to="/salles/new">Nouveau</RouterLink>
            ...
            <div v-else class="table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  <tr v-for="s in salles" :key="s.id">
                    <td>{{ s.id }}</td>
                    <td>{{ s.nom }}</td>
                    <td>{{ s.capacite }}</td>
                    <td class="text-end">
                      <RouterLink class="btn btn-sm btn-outline-secondary me-2" :to="`/salles/${s.id}/edit`">
                        Modifier
                      </RouterLink>
                      <button class="btn btn-sm btn-outline-danger" type="button" @click="remove(s.id)">
                        Supprimer
                      </button>
                    </td>
                  </tr>
